...
SET VCPKG_BINARY_SOURCES=clear;files,C:\build\vcpkg.cache,readwrite

call %SETUP_MSVC_2019%
cmake -G "Visual Studio 16 2019" -A x64 -T "v142" -DCMAKE_TOOLCHAIN_FILE=C:\build\vcpkg\scripts\buildsystems\vcpkg.cmake -H. -Bbuild.sln
